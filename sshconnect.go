...
func(sshobject *SSHS3UploadAPI) dialConnection(host,port,username,pwd string)(error){
...
func main() {
	...
	//Create a SSH connection using input parameters
	sshAPIObject.dialConnection()

	fileReference,err:=os.Open(sshAPIObject.FilePath)
}
